...
- Autonomous ecology: a vignette director runs 1-2 little scenes at a time with zero input — critters nap (eyes shut, zzz, wake with a jiggle), gather and peck-bob around a mushroom, play tag (roles swap on a happy bounce), greet each other, a flyer lazily circles a tree canopy, a parade of critters follows a leader across the meadow, serpents form a conga line behind a leader, and idlers amble over to a neighbor out of curiosity. Weighted so the meadow never goes to chaos; owls keep their own perch/glide life.
